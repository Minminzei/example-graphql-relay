...
export type Chat_pagination_query$variables = {
  after?: string | null;
  first?: number | null;
  id: string;
};
export type Chat_pagination_query$data = {
  readonly node: {
    readonly " $fragmentSpreads": FragmentRefs<"Chat_pagination">;
  };
};
export type Chat_pagination_query = {
  response: Chat_pagination_query$data;
  variables: Chat_pagination_query$variables;
};
